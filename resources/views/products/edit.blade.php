                        ...
                        <div class="border p-3 rounded">
                            <form class="row g-3" action="{{route('product.update',['product'=>$product->id])}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="description" class="form-control" placeholder="توضیحات کامل" rows="4">{{ $product->description }}</textarea>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-check">
                                        <input name="is_special" class="form-check-input" @if($product->is_special == 1) checked @endif type="checkbox" value="1" id="flexCheckDefault">
                                        <label class="form-check-label" for="flexCheckDefault">محصولات پیشنهادی</label>
                                    </div>
                                </div>

                                <div class="col-12">
                                    <button class="btn btn-primary px-4">ویرایش محصول</button>
                                </div>
                            </form>
                        </div>
                    </div>
