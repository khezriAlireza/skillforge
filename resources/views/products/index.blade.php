                ...
                <div class="table-responsive">
                    <table class="table align-middle">
                        ...
                        @foreach($products as $index => $product)
                            <tr>
                                <td>{{ $products->firstItem() + $index }}</td> <!-- شماره واقعی هر سطر -->
                                <td>{{$product->name}}</td>
                                ...
                                <td>@if(empty($product->discount)){{'بدون تخفیف'}}@else{{$product->discount.'%'}}@endif</td>
                                <td>
                                ...
                                <td>
                                    @if($product->active == 0)
                                        {{__('محصول فعال نمی باشد')}}
                                    @elseif($product->active == 1)
                                        {{__('محصول فعال می باشد')}}
                                    @endif
                                </td>
                                <td>
                                    @if($product->is_special == 0)
                                        {{__('محصول پیشنهادی نمی باشد')}}
                                    @elseif($product->is_special == 1)
                                        {{__('محصول پیشنهادی می باشد')}}
                                    @endif
                                </td>
                                <td>
                                    {{$product->stock}}
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-3 fs-6">
                                        <a href="{{route('product.edit',['product'=>$product->id])}}"
                                           ...
                                           title="" data-bs-original-title="ویرایش اطلاعات" aria-label="Edit"><i
