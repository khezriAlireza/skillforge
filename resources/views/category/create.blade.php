    ...
    <main class="page-content">
        ...
        <div class="card">
            <div class="card-header py-3">
                <h6 class="mb-0">اضافه کردن دسته محصول</h6>
            </div>
            <div class="card-body">
                <div class="row">
                            ...
                            <div class="card-body">
                                <form class="row g-3" method="post" action="{{route('category.store')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="نام دسته">
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control" name="description" rows="3" cols="3" placeholder="توضیحات محصول"></textarea>
                                    </div>
                                    <div class="col-12">
                                        <div class="d-grid">
                                            <button class="btn btn-primary">اضافه کردن دسته</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle">
                                        ...
                                        @foreach($categories as $index => $category)
                                            <tr>
                                            <td>{{ $categories->firstItem() + $index }}</td> <!-- شماره واقعی هر سطر -->
                                            <td>{{$category->name}}</td>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center gap-3 fs-6">
                                                    <a href="{{route('category.edit',['category'=>$category->id])}}" class="text-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="" data-bs-original-title="ویرایش اطلاعات" aria-label="Edit"><i class="bi bi-pencil-fill"></i></a>
                                                    <form action="{{ route('category.destroy', ['category' => $category->id]) }}" method="POST" id="delete-form-{{ $category->id }}">
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="javascript:;" class="text-danger" data-bs-toggle="tooltip" data-bs-placement="bottom" title="حذف" aria-label="Delete" onclick="confirmDelete({{ $category->id }})">
