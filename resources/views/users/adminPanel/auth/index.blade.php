...
<div class="wrapper">
    ...
    <main class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{__('کاستر')}}</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('مدیریت کارکنان')}}</li>
                        <li class="breadcrumb-item active" aria-current="page">{{__('لیست کارکنان')}}</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                            ...
                            <table id="example" class="table align-middle">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-outline-danger px-4" onclick="confirmDelete({{ $user->id }})">{{ __('حذف کاربر') }}</button>
...
<script defer>
    function confirmDelete(userId) {
        var isConfirmed = confirm("آیا مطمئن هستید که می‌خواهید حساب کاربر را حذف کنید؟");

        if (isConfirmed) {
            // If confirmed, submit the form
            location.href = '{{ url('/user/delete') }}/' + userId;
        }
    }
</script>
