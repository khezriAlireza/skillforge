            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('admin.blog') }}</li>
                        <li class="breadcrumb-item active" aria-current="page">{{ __('admin.edit_post') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="p-4 border rounded">
                                <div class="container">
                                    <div style="position: relative; padding: 20%">
                                        <div class="p-5">
                                            <img
                                                style="position: absolute; top: 0px; left: 0px; width: 100%; height: 100%; background-size: cover; background-repeat: no-repeat;"
                                    ...
                                    <div class="form-group mt-3 mb-4">
                                        <div class="row">
                                            ...
                                            <div class="col-5 text-center">
                                                ...
                                                <input required autofocus value="{{$post->title}}" type="text" name="title" class="form-control">
                                            </div>
                                            <div class="col-2 mt-4">
                                                <button class="btn btn-primary">{{ __('admin.edit_post') }}</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <textarea name="text" id="my-editor">
                                            {!! $post->text !!}
                                        </textarea>
                                    </div>
                                </div>
